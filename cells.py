...
#from keras.src.layers import Dense, Activation, add
from recurrentshop.cells import *
# from keras.models import Model
from keras.src.layers import Input, Dense, Lambda, Activation
from keras.src.layers import add, multiply, concatenate
