...
if __name__ == '__main__':
    ...
    test_lstm_autoencoder(30, [80], 0.0001, 16, 200, 0.8, True, True, ["./aufnahmen/csv/autocross_valid_16_05_23", "./aufnahmen/csv/autocross_valid_run", "./aufnahmen/csv/anomalous data", "./aufnahmen/csv/test data/ebs_test_steering_motor_encoder_damage"], "can_interface-wheelspeed.csv") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps20_layers_40.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps40_layers_300.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps40_layers_120.keras")
    #test_lstm_autoencoder(20, [30], 0.0, 8, 200, 0.9, True, True, ["./aufnahmen/csv/skidpad_valid_fast2_17_47_28", "./aufnahmen/csv/skidpad_valid_fast3_17_58_41", "./aufnahmen/csv/anomalous data", "./aufnahmen/csv/test data/skidpad_falscher_lenkungsoffset"], "can_interface-current_steering_angle.csv") #, "./models/LSTM_autoencoder_decoder_can_interface-current_steering_angle_timesteps40_layers_50.keras")
