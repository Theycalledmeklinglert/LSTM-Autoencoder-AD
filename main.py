...
if __name__ == '__main__':
    ...
    #test_lstm_autoencoder(20, [40], 0.0, 32, 500, ["./aufnahmen/csv/csv test 1", "./aufnahmen/csv/csv test 2"], "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps20_layers_40.keras")
    ...
    #df = old_directory_csv_files_to_dataframe_to_numpyArray("./aufnahmen/tmp/autocross_valid_run.bag")
