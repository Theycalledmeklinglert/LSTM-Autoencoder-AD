...
if __name__ == '__main__':
    ...
    test_lstm_autoencoder(30, [15], 0.0001, 16, 200, 0.8, True, True, ["./aufnahmen/csv/autocross_valid_16_05_23", "./aufnahmen/csv/autocross_valid_run", "./aufnahmen/csv/anomalous data", "./aufnahmen/csv/test data/ebs_test_steering_motor_encoder_damage"], "can_interface-wheelspeed.csv") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps20_layers_30.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps20_layers_50.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps20_layers_40.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps100_layers_150.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps40_layers_300.keras") #, "./models/LSTM_autoencoder_decoder_can_interface-wheelspeed_timesteps40_layers_120.keras")
